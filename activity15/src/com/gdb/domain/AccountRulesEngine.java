...
public class AccountRulesEngine {
    ...
    public double getDailyTransferLimit(String accountType, int tenureYears) {
        ...
        // Get the daily transfer limit from the rule's additional features.
        ...
        // If no daily transfer limit is configured,
        // return 0.0 as the default.
        if (value == null) {
            return 0.0;
        }

        // The properties loader stores daily transfer limits
        // as Double values, so cast the value to Double.
        return (Double) value;
    }
